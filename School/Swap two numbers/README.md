<h2><a href="https://practice.geeksforgeeks.org/problems/swap-two-numbers3844/1?page=1&difficulty=School&sortBy=submissions">Swap two numbers</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 20px;">Swap given two numbers and print them. (Try to do it without a temporary variable.) and return it.</span></p>
